...
function App() {
  ...
  const notifyEmptyUpload1 = () => toast.warning('No se ha convertido ningun archivo, no se puede copiar nada');
  const notifyEmptyUpload2 = () => toast.warning('No se ha convertido ningun archivo, no se puede descargar nada');
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-8 px-4 py-12">
      <h1 className="font-bold text-5xl text-left">Convertidor de CSV a JSON</h1>
      <h3 className='text-white font-bold text-xl text-center bg-celestialBlue p-1 rounded-md'>Convierte tus archivos CSV a JSON y 3ncr1pt4 los datos sensibles</h3>
      <div className="flex flex-col bg-whiteSmoke rounded-2xl p-6 max-w-5xl border shadow-lg">
        <div className="flex flex-row justify-between  gap-5 mb-6">
          ...
          <label className="form-control w-full">
            <div className="label">
              <span className="label-text font-bold">Escoja su archivo CSV</span>
            </div>
            <input
              type="file"
          ...
          <label className="form-control w-full">
            <div className="label">
              <span className="label-text font-bold">Ingrese el delimitador del CSV</span>
            </div>
            <input type="text"
        ...
        <label className="form-control w-full space-y-2">
          <div className="label">
            <span className="label-text font-bold">Ingrese la clave de encriptacion</span>
          </div>
          <input type="text"
            placeholder="Type here"
            className="input input-bordered w-full"
        ...
        <button onClick={handleSubmit} className="btn bg-resedaGreen text-white w-3/12">
          Convertir a JSON
        </button>
        <div className="flex flex-col gap-4 w-full">
